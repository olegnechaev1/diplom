...
class Comment(models.Model):
    author = models.ForeignKey('news.User', on_delete=models.CASCADE, related_name='author',blank=True, null=True)
    comment = models.TextField(blank=True, null=True)
    date = models.DateTimeField(auto_now=True)
    liked = models.ManyToManyField('news.User', blank=True, related_name='liked')
...
class Like(models.Model):
    user = models.ForeignKey('news.User', on_delete=models.CASCADE, related_name='user')
